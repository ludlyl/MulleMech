...
namespace Overseer{
    ...
    /**
    * \struct ComparePointPairs Region.h "src/Region.h"
    * \brief Check if two PointPairs are equal.
    */
    ...
    class Region {
        public:
            ...
            */
            ...
            /**
            * \brief set the region id (INTERNAL USE ONLY)
            *
            * \param the id to set
            */
            ...
            */
            ...
            /**
            * \brief Merges two regions (INTERNAL USE ONLY).
            *
            ...
            */
            ...
            /**
            * \brief clear this region of its tile positions  (INTERNAL USE ONLY).
            */
            void clear();
