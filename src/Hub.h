...
struct Hub {
    ...
    bool AssignBuildingProduction(Order* order_, sc2::UNIT_TYPEID building_ = sc2::UNIT_TYPEID::INVALID, std::optional<sc2::UNIT_TYPEID> addon_requirement_ = std::nullopt);
